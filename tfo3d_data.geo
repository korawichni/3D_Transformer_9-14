...
rp00 = 0.00252/2;//0.0043/2;  

rs00 = 0.00252/2; //interwire_sec = 0.003; //0.003676; //0.003;//
strand_dia_pri_00 = 0.21*mm;
strand_dia_sec_00 = 0.21*mm;
strand_number_pri_00 = 100;//200;
...
//============== For 13:13 configuration ===============//
interwire_pri = 0.00005;//0.0035/4, 0.005065;
interwire_sec = 0.00007; //0.003 + 0.0005; //0.003676; //0.003;//

xs0 = 0.01781; ys0 = 0.01686+0.001; zs0 = z0;
xp0 = xs0+rs00+rp00+thick_insul00+0.17*2*mm;//0.022775; 
yp0 = 0.01686+0.9*mm;//0.0156+0.002; 
zp0 = z0;
xs1 = 0.02774; ys1 = 0.01686; zs1 = z0;
...
DefineConstant[
	...
	_flag_interleave = { 0, Choices{0,1}, Name StrCat[ppw, "/10Interleaved winding" ], Highlight "LightGreen"}
